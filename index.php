	...
	function update()
	{
		$.get("api/get_checkins.php", function(data) {
			...
			if(json!=null)
			{
				...
				{
					var c = json[i];
					newcheckin += "<p>" + c.timestamp + " " + c.location + " " + c.player + "</p>";
				}
  ...
  <body onload="update()">
    ...
    <div class="container">
		...
		<form class="form-inline" id="postform">
			<input class="input-small" id="post_location" type="text" name="post_location" placeholder="Location"/>
			<input class="input-large" id="post_player" type="text" name="post_player" placeholder="Player"/>
